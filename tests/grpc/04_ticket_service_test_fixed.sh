...
# TicketService gRPC E2E Test (Fixed Version)
# Tests all 11 interfaces of the TicketService with correct proto definitions
# Uses grpcurl with real JWT authentication

echo "🎫 TicketService gRPC E2E Test (Fixed) - 11 interfaces"
echo "===================================================="
...
TEST_PRIORITY="TICKET_PRIORITY_NORMAL"  # Correct enum value
...
# Test 1: CreateTicket (with correct RequestMetadata structure)
create_ticket_data="{\"metadata\": {\"tenant_id\": \"$TENANT_ID\", \"user_id\": \"$USER_ID\"}, \"title\": \"$TEST_TITLE\", \"description\": \"$TEST_DESCRIPTION\", \"priority\": \"$TEST_PRIORITY\", \"severity\": \"$TEST_SEVERITY\"}"
...
# Test 2: GetTicket (with correct field name)
if [ ! -z "$TICKET_ID" ]; then
...
# Test 3: ListTickets (with correct pagination structure)
...
# Test 10: SearchTickets (with correct pagination structure)
