// Package moderncsqlite is a GORM dialector for SQLite backed by
// modernc.org/sqlite (the pure-Go, CGO-free driver).
//
// Vendored and adapted from github.com/glebarez/sqlite (MIT) to use
// modernc.org/sqlite directly. See the LICENSE file in this directory for
// the original MIT license attribution.
